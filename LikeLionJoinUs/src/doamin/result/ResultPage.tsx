				...
				{data ? (
					<>
						...
						<div className="flex flex-col items-center justify-center mt-2">
							<div
								className="bg-[url('/~s20231073/assets/img/balloon_box.png')] w-full max-w-[70%] h-[70px] bg-contain bg-no-repeat bg-center flex flex-col items-center justify-center pb-2 mt-7 -mb-5 
				small:max-w-[90%] small:h-[60px] 
				medium:max-w-[70%] medium:h-[80px] 
				tablet:max-w-[60%] tablet:h-[100px] 
				laptop:max-w-[30%] laptop:h-[100px]"
							>
								<div className="text-[11px] mb-4 laptop:mb-6 small:text-[11px] medium:text-[13px] tablet:text-[17px] tablet:mb-6 laptop:text-[17px]">
