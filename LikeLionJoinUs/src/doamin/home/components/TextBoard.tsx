...
const TextBoard = ({ text }: textProps): JSX.Element => {
	return (
		<div className="bg-[length:100%_100%] bg-[url('/~s20231073/assets/img/ballon_wide.png')]  w-[20rem] h-[6.4rem] flex flex-row items-center justify-center medium:w-[29rem] medium:h-[8rem] tablet:w-[35rem] tablet:h-[10rem]">
